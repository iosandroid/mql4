...
static datetime StartTime = D'2016.06.27';

static string SymbolsStr;
static int Depth, Iterations, Method;
static bool Correlation;

static string Symbols[MAX_AMOUNTSYMBOLS];
static double BaseMatrix[][MAX_POINTS], MOMatrix[][MAX_POINTS];
static double CvarMatrix[][MAX_AMOUNTSYMBOLS];
static double Means[], SVector[], Divs[];
static int Times[MAX_POINTS];
static int AmountSymbols, MatrixRows, Time0;
static int CurrPos;

static int AmountSymbols2;
static int AmountVariants, Variants[];

static string UName;

static double Matrix[][MAX_AMOUNTSYMBOLS], VectorTmp[];
