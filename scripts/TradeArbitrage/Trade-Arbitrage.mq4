// за две недели тестов для себя сделал следущие выводы
// 1 от брокера зависит очень много
// 2 значение min pips надо ставить 3-5 
// 3 включать lock =true 
// 4 количество строк в arbitrage trade не должно превышать 15-20 
// 5 самое главное-правильно подобрать валюты 
// 6 правильно подобрать размер лота 
// 7 просадка не превышает 3-5 % от депо при самой худшей ситтуации
